...
public enum Block_kdk500 implements Block {
    FRONT_PANEL_I7050(R.string.front_panel_i7050_A21,
            ...
            Const.BLOCK_01h),
    FRONT_PANEL_I7063B(R.string.front_panel_i7063B_A22,
            R.string.A1_A22, R.drawable.thumbnail_i7063b,
            R.color.colorGreenForConnection,
            R.color.colorRedForConnection,
            R.string.connection_available,
            R.string.connection_not_available,
    ...
    CONTROL_UNIT_I7050(R.string.control_unit_i7050_A10,
            ...
            R.string.connection_not_available,
            Const.BLOCK_11h),
    CONTROL_UNIT_NL_8AI_1(R.string.control_unit_NL_8AI_A13,
            R.string.A1_A13,
            R.drawable.thumbnail_nl_8ai_ex,
            R.color.colorGreenForConnection,
            R.color.colorRedForConnection,
            R.string.connection_available,
            R.string.connection_not_available,
            Const.BLOCK_12h),
    CONTROL_UNIT_NL_8AI_2(R.string.control_unit_NL_8AI_A14,
            R.string.A1_A14,
            R.drawable.thumbnail_nl_8ai_ex,
            R.color.colorGreenForConnection,
            R.color.colorRedForConnection,
            ...
            R.string.connection_not_available,
            Const.BLOCK_13h),
    CONTROL_UNIT_NL_8AI_3(R.string.control_unit_NL_8AI_A15,
            R.string.A1_A15,
            R.drawable.thumbnail_nl_8ai_ex,
            R.color.colorGreenForConnection,
            R.color.colorRedForConnection,
    ...
    BREAKERS_PANEL_BKS2(R.string.breakers_panel_BKS2_A7,
            ...
            R.string.connection_not_available,
            Const.BLOCK_26h),
    LEFT_CONTROL_PANEL_NL_16DI_EX(R.string.left_control_panel_NL_16DI_Ex_A1,
            R.string.A2_A1,
            R.drawable.thumbnail_nl_16di_ex,
            R.color.colorGreenForConnection,
            R.color.colorRedForConnection,
            R.string.connection_available,
            R.string.connection_not_available,
    ...
    LEFT_CONTROL_PANEL_INDICATOR(R.string.left_control_panel_codes_display_A3,
            ...
            R.string.connection_not_available,
            Const.BLOCK_91h),
    RIGHT_CONTROL_PANEL_NL_16DI_EX(R.string.right_control_panel_NL_16DI_Ex_A1,
            R.string.A3_A1,
            R.drawable.thumbnail_nl_16di_ex,
            R.color.colorGreenForConnection,
            R.color.colorRedForConnection,
    ...
    Block_kdk500(@StringRes int blockShortNameResourceId, @StringRes int blockAddressResourceId, int blockThumbnailResourceId,
