...
public enum Block_cls450 implements Block {
    ...
    LEFT_CONTROL_PANEL_tCON(R.string.left_control_panel_tCON_A1,
            ...
            R.string.connection_not_available,
            Const.BLOCK_31h),
    LEFT_CONTROL_PANEL_I7017(R.string.left_control_panel_i7017_A2,
            R.string.A2_A2,
    ...
    RIGHT_CONTROL_PANEL_tCON(R.string.right_control_panel_tCON_A1,
            ...
            R.string.connection_not_available,
            Const.BLOCK_41h),
    RIGHT_CONTROL_PANEL_I7017(R.string.right_control_panel_i7017_A2,
            R.string.A3_A2,
            R.drawable.thumbnail_i7017f,
            R.color.colorGreenForConnection,
            R.color.colorRedForConnection,
    ...
    Block_cls450(@StringRes int blockShortNameResourceId, @StringRes int blockAddressResourceId, int blockThumbnailResourceId,
